...
class AlquilerResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form
            ->schema([
                Forms\Components\TextInput::make('soc_id')
                    ->required()
                    ->numeric(),
                Forms\Components\TextInput::make('pel_id')
                    ->required()
                    ->numeric(),
    ...
    public static function table(Table $table): Table
    {
        return $table
            ->columns([
                Tables\Columns\TextColumn::make('soc_id')
                    ->numeric()
                    ->sortable(),
                Tables\Columns\TextColumn::make('pel_id')
                    ->numeric()
                    ->sortable(),
